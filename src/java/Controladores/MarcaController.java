...
import Repositorios.MarcaFacade;
...
public class MarcaController implements Serializable {
    ...
    @EJB
    private Repositorios.MarcaFacade ejbFacade;
    ...
    public static class MarcaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Marca) {
                ...
                return getStringKey(o.getCodMarca());
            } else {
    ...
    public static SelectItem[] getSelectItems(List<Marca> entities, boolean selectOne) {
        int size = selectOne ? entities.size() + 1 : entities.size();
        SelectItem[] items = new SelectItem[size];
        int i = 0;
        if (selectOne) {
            items[0] = new SelectItem("-1", "Selecciona una marca");
            i++;
        }
        for (Marca x : entities) {
            items[i++] = new SelectItem(x, x.getNomMarca()/*+ " " + x.getApellido2() + ", " + x.getNomAutor()*/);
        }
        return items;
    }
}
