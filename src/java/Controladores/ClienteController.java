...
import Repositorios.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private Repositorios.ClienteFacade ejbFacade;
    ...
    public static SelectItem[] getSelectItems(List<Cliente> entities, boolean selectOne) {
        ...
        for (Cliente x : entities) {
            items[i++] = new SelectItem(x, x.getNomCliente());
        }
        return items;
    }
